    ...
    <div className="grid lg:grid-cols-2 gap-5 items-start">
      ...
      <section className="tarjeta p-6">
        ...
        <form onSubmit={onSubmit} className="max-w-md">
          ...
          {ok && (
            <div className="mt-3.5 text-sm font-semibold px-3.5 py-2.5 rounded-chico" style={{ color: "#1b9aa0", background: "rgba(107,225,227,.12)", border: "1px solid rgba(107,225,227,.3)" }}>
