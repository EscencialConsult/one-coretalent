  ...
  return (
    <div className="min-h-[70vh] grid place-items-center px-4">
      <div className="tarjeta w-full max-w-sm p-8">
        ...
        {ok ? (
          <div className="text-sm text-center px-3.5 py-4 rounded-chico mt-4" style={{ color: "#1b9aa0", background: "rgba(107,225,227,.12)", border: "1px solid rgba(107,225,227,.3)" }}>
